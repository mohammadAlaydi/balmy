...
const SearchComponent = ({ products, maxHeight }: { products: any[], maxHeight?: string }) => {
  return (
    <div className={`w-full h-full flex flex-col gap-5 py-3 ${maxHeight || "h-full"}`}>
      ...
      <div className="w-full h-full grid grid-cols-12 gap-2 overflow-y-auto justify-center p-3">
