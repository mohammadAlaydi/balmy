...
//         className={cn(
//           "cursor-pointer lg:cursor-default focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-start justify-between gap-4 rounded-md py-4 text-left text-sm font-medium transition-all outline-none hover:underline focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180",
//           className
//         )}
//         {...props}
//       >
...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      data-slot="accordion-content"
      className={cn(
        // normal accordion behaviour < lg
        "data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden text-sm",

        // ≥ lg: override to force always open
        "lg:animate-none lg:h-auto lg:overflow-visible lg:data-[state=closed]:h-auto lg:data-[state=closed]:opacity-100 lg:data-[state=open]:h-auto",
