      ...
      <div className="z-10 pb-10">
        ...
        >
          <CardContent className="flex flex-col items-center justify-center p-0 text-center">
            <Badge className="text-white p-0 bg-transparent text-xs sm:text-sm md:text-lg ">
              لم يعد
            </Badge>
            <Badge className="text-red-color p-0 bg-transparent text-xs sm:text-sm md:text-lg">
              الصنف
            </Badge>
            <Badge className="text-white p-0 bg-transparent text-xs sm:text-sm md:text-lg">
              متوفر
