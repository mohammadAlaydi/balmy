...
export default function ContactUsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-600 to-green-700 text-white py-12 sm:py-16 lg:py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start space-x-3 sm:space-x-4 rtl:space-x-reverse">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 text-sm sm:text-base">+966-55-766-5585</p>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4 rtl:space-x-reverse">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 text-sm sm:text-base">info@farada.com</p>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4 rtl:space-x-reverse">
                  ...
                  <div>
                    ...
                    <p className="text-purple-600 text-sm sm:text-base">طريق أنس ابن مالك، الصحافة، الرياض 13321</p>
            ...
            <form className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200 text-sm sm:text-base resize-vertical"
                  required
                ></textarea>
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-green-600 text-white py-3 sm:py-4 px-6 sm:px-8 rounded-lg font-semibold text-base sm:text-lg hover:from-blue-700 hover:to-green-700 transition-all duration-200 transform hover:scale-105 focus:ring-4 focus:ring-blue-300"
              >
                {t("sendMessageButton")}
              </button>
            </form>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 text-center">
          <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10 border border-blue-200">
