            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <h3 className="font-bold text-gray-800 text-base sm:text-lg">{t("salesRepresentative")}</h3>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("fullTime")}</span>
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("riyadh")}</span>
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("experience2Plus")}</span>
                </div>
              </div>

              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <h3 className="font-bold text-gray-800 text-base sm:text-lg">{t("warehouseSupervisor")}</h3>
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gray-600 rounded-full"></div>
                </div>
                <p className="text-gray-700 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("fullTime")}</span>
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("riyadh")}</span>
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("experience3Plus")}</span>
                </div>
              </div>

              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <h3 className="font-bold text-gray-800 text-base sm:text-lg">{t("webDeveloper")}</h3>
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gray-600 rounded-full"></div>
                </div>
                <p className="text-gray-700 mb-3 sm:mb-4 leading-relaxed text-sm sm:text-base">
                  {t("webDeveloperDesc")}
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("fullTime")}</span>
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("remote")}</span>
                  <span className="bg-gray-200 text-gray-800 text-xs px-2 sm:px-3 py-1 rounded-full font-medium">{t("experience2Plus")}</span>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                <div>
                  <ol className="list-decimal list-inside space-y-3 sm:space-y-4 text-gray-700 text-sm sm:text-base lg:text-lg">
                    <li>{t("applyStep1")} <span className="font-semibold text-gray-600">careers@farada.com</span></li>
                    <li>{t("applyStep2")}</li>
                    <li>{t("applyStep3")}</li>
                    <li>{t("applyStep4")}</li>
                  </ol>
            ...
            <div className="bg-gray-50 p-6 sm:p-8 rounded-xl border border-gray-200">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 text-center">
                <div className="bg-white p-3 sm:p-4 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600 text-sm sm:text-base">careers@farada.com</p>
                </div>
                <div className="bg-white p-3 sm:p-4 rounded-lg shadow-md">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-700 rounded-full flex items-center justify-center mb-2 sm:mb-3 mx-auto">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-white p-3 sm:p-4 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600 text-sm sm:text-base">{t("sundayThursday")}<br/>9:00 ص - 6:00 م</p>
                </div>
              </div>
            </div>
          </section>
