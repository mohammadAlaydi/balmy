...
export const MOCK_PRODUCTS = {
  data: [
    ...
    // Category 2: العــــــروض (Offers)
    {
      id: 4,
      product_id: 4,
      name: "جورجيو أرماني | عطر أرماني | سترونجر ويذ يو إنتنسلي",
      price: 789,
      special_price: 480,
      formatted_price: "480.00 ج.م",
      sku: "ARMANI-001",
      in_stock: true,
      inStock: true,
      new: false,
      ...
      brand: "جورجيو أرماني",
      short_description: "عطر رجالي فاخر من أرماني - خصم خاص",
      description: "جورجيو أرماني | عطر أرماني | سترونجر ويذ يو إنتنسلي - عطر رجالي قوي ومنعش يجمع بين الأناقة والجاذبية.",
      variants: [],
    },
    {
      id: 5,
